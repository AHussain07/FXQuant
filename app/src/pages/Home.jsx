...
const STEPS = [
  {
    title: "Trade",
    body: "Live prices and real order mechanics. Nothing at stake.",
  },
  {
    title: "Journal",
    body: "Log why you took it, while the reason is still fresh.",
  },
  {
    title: "Review",
    body: "See which of your setups make money, and cut the ones that lose.",
  },
];
...
const CARDS = [
  {
    title: "Trade journal",
    body: "Document every trade with detailed notes and a full edit history so you can learn from your wins and losses.",
  },
  {
  ...
  },
  {
    ...
    body: "Practise proprietary trading firm challenges. $50K to $150K, 6% target, 4% max loss.",
  },
  {
    title: "Economic calendar",
    body: "High impact news for both sides of your pair.",
  },
];
  ...
  return (
    <div className="lp">
      ...
      <main>
          ...
          <div className="lp-shell lp-hero-inner">
            <div className="lp-hero-copy">
              ...
              <p className="lp-fineprint">
                No card. No deposit. Nothing real at risk.
              </p>
            </div>
            ...
            <aside className="lp-panel" aria-label="Example performance">
              ...
              <div className="lp-insight">
                ...
                <span className="lp-insight-meta">
                  68% win rate across 19 trades
                </span>
              </div>
            </aside>
          </div>
        ...
        <section
          className="lp-rail-strip"
          aria-label="Pairs covered by the daily bias"
        >
            ...
            <div className="lp-marquee-track" aria-hidden="true">
              {[...TICKER_LAP, ...TICKER_LAP].map((p, i) => (
                <div className="lp-tick" key={`${p.symbol}-${i}`}>
                  ...
                  <span
                    className={`lp-tick-bias lp-bias-${p.bias.toLowerCase()}`}
                  >
                    {p.bias}
                  </span>
                </div>
            ...
            <div className="lp-bento">
              <article className="lp-card lp-card-wide">
                ...
                <h3 className="lp-card-title">
                  A second opinion, every morning
                </h3>
                <p className="lp-card-body">
                  A machine learning model that forecasts price action for the
                  coming session.
                </p>
                <div className="lp-verdict">
                  ...
                  <span className="lp-verdict-driver">
